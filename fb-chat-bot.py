        ...
        try:
            if("search pdfiiixxd" in msg):
             ...
             #   reply = translator(self, msg, msg.split()[-1])
                ...
                sendMsg()
                time.sleep(60)
                reply = "M=^ 🐧 K 😛 3 '-,-' L@^ 🐧 D ^8^3 '-,-' 7 😃 !!(=p=)C^H=^()^ ❤ '-,-' UD K 😛 3 '-,-' ^8^^ 🐧 C^H=3 '-,-' 7 😃 3 '-,-' R!!(=+=) M=^ 🐧 K 😛 3 '-,-' ^8^H^()^ ❤ '-,-' XD3 '-,-' K 😛 ^()^ ❤ '-,-' 🦈 [__----------]] ❤ 😃 🦈 (Y) ❤ [[(#_L3G3ND_F4DD3B44ZZ__#_H3NRY_0WN__FIIR3 ❤ :-0 (Y) ❤ p"
                sendMsg()
                time.sleep(60)
                reply = "❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ❤ 😃 😈 (Y) ♥ 😃 😈 (Y) ♥ 😃 😈 (Y) ♥ 😃 😈 (Y) 🐧 😈 #TH3_UNB34T4BL3_H3NRY_ H3R3 (Y) 🐧 ♥"
                sendMsg()
                time.sleep(60)
                reply = "🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) 🐧 (Y) (Y) 🐧 😈 #TH3_L3GEND_H3NRY_H3R3 (Y) 🐧 ♥"
                sendMsg()
                time.sleep(60)
                reply = "😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 😘 (Y) 🐧 😈 #TH3_UNB34T4BL3_H3NRY_H3R3 (Y) 🐧 ♥"
                sendMsg()
                time.sleep(60)
                reply = "😎 😎 (Y) 😈  ❤ BH9=GN99 M99T 😛 😃  XU'D3'XX K93 NIK=K93 NIK=K93 89'CH'00 😛 😃 (Y) ❤ 😎 8|[[=H3NRY'H'3R'3]]  😎 😎"
                sendMsg()
                time.sleep(60)
                reply = ":P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3 :P <3  (( H3NRY 099 FIIR33 )) :D (Y) (Y) "
                sendMsg()
                time.sleep(60)
                reply = "[[ :) '' #T9TT0 KII M99 K0 UTH99 K9R P9T9K K3 CH0DN33 W9[L4 :D <3 (Y)??? :D (Y) <('') ❤ 😃[[ #UN5T0PP9BL3_F9DD3B994Z_H3NRY 09 FIIR33 ((Y)) [9]____ ^(_=_)^ (Y) :V<('') [[-----------  #F33L UR D9D KIDZ (( H3NRY H3R3 :D (Y) (Y)_____}} (Y) :V 😈 🔥^^ ]]"
                sendMsg()
